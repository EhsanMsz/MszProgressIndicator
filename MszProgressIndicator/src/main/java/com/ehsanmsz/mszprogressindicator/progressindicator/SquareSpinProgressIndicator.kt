...
private const val DefaultAnimationDuration = 1800
private const val DefaultAnimationDelay = 1800
...
fun SquareSpinProgressIndicator(
    ...
    val path = with(LocalDensity.current) {
        getSquarePath(Size(width.toPx(), height.toPx()))
    }
...
private fun getSquarePath(size: Size): Path {
    return Path().apply {
